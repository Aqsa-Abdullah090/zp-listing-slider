...
const HeroContent = ({ agent }) => {
  return (
    ...
    >
      ...
      />
       <p className="text-white text-[10.00px] lg:text-[13.85px] 2xl:text-[18px] tracking-[3px] uppercase whitespace-nowrap">
        <span dir="ltr">$</span>
        {agent.amount} {agent.currency}
      </p>
      <div className="overflow-hidden sm:overflow-visible uppercase flex space-x-[16.67px] lg:space-x-[23.08px] 2xl:space-x-[32px] whitespace-nowrap text-[6.67px] lg:text-[6.5px] xl:text-[9.23px] 2xl:text-[12px] text-white tracking-[3px]">
      ...
      <button className="h-[20px] lg:h-[27.69px] 2xl:h-[36px] px-4 2xl:px-6  flex justify-between space-x-4 text-white bg-transparent hover:bg-white hover:text-black transition-all duration-300 border-2 border-white items-center text-[7.78px] lg:text-[10.77px] 2xl:text-[14px] tracking-[2.5px] whitespace-nowrap cursor-pointer">
        <p>
          <span dir="ltr">$</span>
          25.00
        </p>
